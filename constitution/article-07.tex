...
% SECTION D: HEAD OF SOCIAL MEDIA
...
% SECTION E: CCDC CAPTAIN
\Section{Collegiate Cyber Defense Competition (CCDC) Team Captain}

\begin{enumerate}
      \item Appointed directly by previous year's captain.
      \item Responsbile for overseeing CCDC operations such as training team 
            members, coordinating competitions and communicating with the 
            RITSEC executive board.
      \item This position reports to both the RITSEC executive board and the
            RIT cybersecurity department.
\end{enumerate}

% SECTION F: CPTC CAPTAIN
\Section{Collegiate Penetration Testing Competition (CPTC) Team Captain}

\begin{enumerate}
      \item Appointed directly by previous year's captain.
      \item Responsbile for overseeing CPTC operations such as training team 
            members, coordinating competitions and communicating with the 
            RITSEC executive board.
      \item This position reports to both the RITSEC executive board and the
            RIT cybersecurity department.
