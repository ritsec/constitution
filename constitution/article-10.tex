...
\begin{enumerate}
      ...
      \item E-Board also has the right to make amendments to the constitution and/or
            ...
            has passed E-Board must present the change(s) to the club. %chktex 36
            \begin{enumerate}
...
\subsection{26 September 2025}
\begin{enumerate}
      \item Addition of competition teams CCDC and CPTC
      \item Definition of general competition team relationship with RITSEC
      \item Expected funding from RITSEC to competition teams

            \subsection{Articles/Bylaws Modified}
            \begin{enumerate}
                  \item Terms
                  \item Article 7, Secitons E, F
                  \item Article 16, Sections A, B, C
            \end{enumerate}

            \subsection{Dates Modified}
            \begin{enumerate}
                  \item 30 September 2025
            \end{enumerate}

            \subsection{Proposing Individuals}
            \begin{enumerate}
                  \item Daniel LaChance
                  \item James Southcott
                  \item Alex Kilroy
            \end{enumerate}
\end{enumerate}