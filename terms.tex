\begin{itemize}
      ...
      \item Competition Teams --- A team which provides benefits to RITSEC and its members
            by training and competing in nationally-recognized security competitions. These 
            groups maintain governance but are overseen by the RITSEC executive board.

      \item Collegiate Cyber Defense Competition (CCDC) --- A nationally recognized security
            defense competition, built as a simulated response on artificial company 
            infrastructure to an active red team.

      \item Collegiate Penetration Testing Competition (CPTC) --- A nationally recognized
            offensive security competition, with a focus on initial access to simulated 
            instructure and report writing.
