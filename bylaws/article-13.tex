...
\begin{enumerate}
	...
	\item An IG receives funding from RITSEC as per 13 RITSEC § C (I).
	\item E-Board reserves the right to amend 13 RITSEC without express club approval
	      and/or vote.
	\item E-Board reserves the right to, by majority vote, disband, remove a chief, or
	      otherwise intervene in Interest Group operations upon a violation of the RITSEC Code of Conduct defined in Article 9, Section A.
...
\begin{enumerate}
	\item Interest Group leads shall forever and henceforth be referred to as ``Chief'' of their
...
\begin{enumerate}
	...
	\item To form an Interest Group, a member must submit an application to E-Board
	      ...
	      \end{enumerate}
	\item All new Interest Groups must be amended to 13 RITSEC of the constitution (as
...
\input{bylaws/interest-groups/03-reverse-engineering}
\input{bylaws/interest-groups/04-wireless}
\input{bylaws/interest-groups/05-physical-security}
\input{bylaws/interest-groups/06-rvapt}
\input{bylaws/interest-groups/07-ops}
\input{bylaws/interest-groups/08-incident-response}